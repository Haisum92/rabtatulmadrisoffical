                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
        						...
        						echo form_open_multipart('admin/addDistrict',$attribute) ?>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="district_name_urdu" id="district_name_urdu" class="form-control" placeholder="شہر کا نام اردو میں" value="<?php echo set_value('district_name_urdu');?>" autocomplete="off" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php foreach ($province_array as $key => $province) {?>
                                                    <option value="<?php echo $province['prov_id'];?>" <?php if(@$_POST['district_province'] = $province['prov_id']){?> selected="selected" <?php }?>><?php echo $province['prov_name_urdu'];?></option>
                                                <?php }?>
                                                </select>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="district_name_eng" id="district_name_eng" class="form-control" placeholder="شہر کا نام انگریزی میں" value="<?php echo set_value('district_name_eng');?>" autocomplete="off" >
