                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <?php }?>
    						    <?php
    							$attribute = array('class' => 'web_form','id' => 'add-student-hifz-course', 
                                                   'name' => 'add-student-hifz-course', 'role' => 'form'
                                                 );
        						echo form_open_multipart('admin/addNewStudentForHifzCourse/'.$class_exam_info[0]['exam_info_id'],$attribute) ?>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-lg-6">
                                                ...
                                                <button type="button" class="btn btn-info btn-sm fa fa-arrow-left" onclick="window.location='<?php echo base_url();?>admin/viewAllStudents'">&nbsp;Back</button>
                                            </div>
                                        </div>
                                    </div><!-- /.row (nested) -->
