...
<?php $this->load->view('admin/navigation');?>
			<!-- BEGIN PAGE CONTENT -->
             ...
             <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">امتحان کی حاضری شیٹ</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <?php }?>
    						    <?php
    							$attribute = array('class' => 'web_form','id' => 'date_sheet',
                                                     'name' => 'date_sheet', 'role' => 'form' );
        						echo form_open_multipart('admin/examAttendance',$attribute) ?>
                                    <div class="row">
