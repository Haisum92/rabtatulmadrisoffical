...
<?php $this->load->view('admin/navigation');?>
			<!-- BEGIN PAGE CONTENT -->
             ...
             <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">(متوستہ،خاصہ،عالیہ۔۔) کے نئے طالب علم کا داخلہ فارم</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <?php }?>
    						    <?php
    							$attribute = array('class' => 'web_form','id' => 'add-student-six-course', 
                                                   'name' => 'add-student-six-course', 'role' => 'form'
                                                 );
        						echo form_open_multipart('admin/addNewStudentForSixCourse/'.$class_exam_info[0]['exam_info_id'],$attribute) ?>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="dob_eng" id="dob_eng" class="form-control" placeholder="xxxx-xx-xx تاریخ پیدا ئش ہندسوں میں" value="<?php echo set_value('dob_eng');?>" autocomplete="off" >
