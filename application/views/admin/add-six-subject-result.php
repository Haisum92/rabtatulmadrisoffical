                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
    						    ...
    						    <?php
                                 ...
                                 // echo '<pre>';print_r($exam_subjects);echo '</pre>';//die();
    							$attribute = array('class' => 'web_form','id' => 'add_six_subject_result', 'name' => 'add_six_subject_result', 'role' => 'form' );
        						echo form_open_multipart('admin/viewSixResult/'.$exam_id.'/'.$exam_type.'/'.$result_info[0]['student_id'],$attribute) ?>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">    
                                                                ...
                                                                <?php if(array_key_exists($resultKey, $result_info)){
                                                                        ...
                                                                        if($result_info[$resultKey]['subject_id'] == $sub['sub_id']){?>
                                                                        ...
                                                                        <?php $resultKey++;
                                                                            ...
                                                                            <input type="text" name="obtained_marks[]" id="obtained_marks_<?php echo $key;?>" class="form-control" placeholder="مضمون کے نمبر" value="0" autocomplete="off"> 
                                                                            <input type="hidden" name="subject_id[]" value="<?php echo $sub['sub_id'];?>">
                                                                        <?php }?>

                                                                <?php }else{?>

                                                                        <input type="text" name="obtained_marks[]" class="form-control" placeholder="مضمون کے نمبر" value="0" autocomplete="off" id="obtained_marks_<?php echo $key;?>" >
                                                                        <input type="hidden" name="subject_id[]" value="<?php echo $sub['sub_id'];?>">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">                                            
                                            ...
                                            <button type="button" class="btn btn-info btn-sm fa fa-arrow-left" onclick="window.location='<?php echo base_url()?>admin/sixSubjectStudents/<?php echo $exam_id;?>'"> Back</button>
                                        </div>
                                    </div><!-- /.row (nested) -->
                                </form>
