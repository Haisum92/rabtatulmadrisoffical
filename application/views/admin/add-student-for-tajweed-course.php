                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <?php }?>
    						    <?php
    							$attribute = array('class' => 'web_form','id' => 'add-student-tajweed-course', 
                                                   'name' => 'add-student-tajweed-course', 'role' => 'form'
                                                 );
        						echo form_open_multipart('admin/addNewStudentForTajweedCourse/'.$class_exam_info[0]['exam_info_id'],$attribute) ?>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-lg-6">
                                                ...
                                                </div><!-- end group for examination center name -->
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
