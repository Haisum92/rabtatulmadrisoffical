...
<title>امتحان شہادۃ الثانویہ العامہ طالبہ</title>
			...
			$count = 1;foreach ($gazetInfo as $key => $info) {?>
			    ...
			    <h2>رابطۃ المدارس ا لا سلا میہ پا کستان</h2>
					...
					<?php if($info['exam_type_id'] ==  1){?>
				    	...
				    	<h2 dir="rtl"> <?php //echo 'نتیجۃ '.$info['exam_name'];?> <?php echo $info['exam_name'];?> &nbsp;&nbsp;(کل نمبر: ۱۰۰۰)</h2>
				    
				    <?php }else{?>
				    
				    	<h2 dir="rtl"><!-- نتیجۃ ضمنی امتحان شہادۃ الثانویہ العامہ (طلبہ) 1436ھ --> <?php echo $info['exam_name'];?> &nbsp;&nbsp;(کل نمبر: ۱۰۰۰)</h2>
				...
				<table  width="940" border="1" align="center" cellpadding="0" cellspacing="0">
				  <tr class="trmain">
				    ...
				    <td width="25"><div align="center">قرآن    و حدیث</div></td>
				    ...
				    <td width="25"><div align="center">المنطق</div></td>
				  ...
				  <tr class="trsec" id="<?php echo $count;?>">
					...
					<?php if($info['subject_id'] != ""){?>
				    	...
				    	<?php 
				    		...
				    		?>
							<td width="25"><div align='center'><?php echo $total_score;?></div></td>
			...
			$count = 1;foreach ($gazetInfo as $key => $info) {?>
			    ...
			    <h2>رابطۃ المدارس ا لا سلا میہ پا کستان</h2>
					...
					<?php if($info['exam_type_id'] ==  1){?>
			    		...
			    		<h2 dir="rtl">نتیجۃ سالانہ امتحان شہادۃ الثانویہ العامہ (طلبہ) 1436ھ <?php //echo $info['exam_name'];?> &nbsp;&nbsp;(کل نمبر: ۱۰۰۰)</h2>
				  ...
				  <?php }// end check for count ?>           	
					...
					<?php if($info['subject_id'] != ""){?>
				    	...
				    	<?php 
				    		...
				    		for($x = 0;$x < $iterator; $x++ ){?>
				    			...
				    			//if($r_count > 1){
				    				if(isset($r_subject_id[$r_count]) and ($subject_id[$x] == $r_subject_id[$r_count]) ){ ?>
					    				...
					    				<?php /*if ($subject_id[$x] == $r_subject_id[$r_count]) {
				    		...
				    		?>
							<td width="25"><div align='center'><?php echo $new_total_score;?></div></td>
