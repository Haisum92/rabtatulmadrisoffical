...
<title> امتحان شہادۃ الثانویہ العامہ طالبات</title>
...
<?php
	if ($gazetInfo != NULL) {
		// echo '<pre>';print_r($gazetInfo);echo '</pre>';die();
		...
		if ($exam_type == 1) {
				    ...
				    <?php if($info['exam_type_id'] ==  1){?>
				    	<h2 dir="rtl"><!-- نتیجۃ سالانہ امتحان شہادۃ الثانویہ العامہ (طالبات) 1436ھ --> <?php echo $info['exam_name'];?> &nbsp;&nbsp;(کل نمبر: ۱۰۰۰)</h2>
				    <?php }else{?>
				    	<h2 dir="rtl"><!-- نتیجۃ ضمنی امتحان شہادۃ الثانویہ العامہ (طالبات) 1436ھ --> <?php echo $info['exam_name'];?> &nbsp;&nbsp;(کل نمبر: ۱۰۰۰)</h2>
				    <?php }?>
					...
					<table  width="940" border="1" align="center" cellpadding="0" cellspacing="0">
					  	...
					  	<tr class="trmain">
						    ...
						    <td width="25"><div align="center">الحدیث</div></td>
						    <td width="25"><div align="center">الصرف</div></td>
						    <td width="25"><div align="center">النحو </div></td>
						    <td width="25"><div align="center">الفقہ</div></td>
						    ...
						    <td width="25"><div align="center">مطالعہ پاکستان</div></td>
						    	...
						    	<?php 
						    		  ...
						    		  $myiterator = 0;for ($x=0; $x < count($exam_subjects); $x++) { ?>
						    		  		...
						    		  		<?php if(isset($subject_id[$myiterator]) and $exam_subjects[$x]['sub_id'] == $subject_id[$myiterator])
						    		  		{
								    			...
								    			<td width="25">
								    				<div align='center'>
									    				<?php if($sub_status[$myiterator] == "absent"){?>
								    					...
								    					<?php }elseif($sub_status[$myiterator] == "cheat"){?>
								    					...
								    					<?php }elseif($obtained_marks[$myiterator] < 40){?>
						    		...
						    		<?php /*for($x = 0;$x < $iterator; $x++ ){?>
						    			...
						    			<td width="25">
						    				<div align='center'>
						    					...
						    					<?php }elseif($obtained_marks[$x] < 40){?>
						    		...
						    		<?php }elseif($total_score >= 400 and $total_score <= 499){?>

						    			<td width="25"><div align='center'><?php echo "مقبول"; ?></div></td>

						    		<?php }elseif($total_score >= 500 and $total_score <= 599 ){?>

						    			<td width="25"><div align='center'><?php echo "جید"; ?></div></td>

						    		<?php }elseif($total_score >= 600 and $total_score <= 699){?>

						    			<td width="25"><div align='center'><?php echo "جید جدا"; ?></div></td>

						    		<?php }elseif($total_score >= 700 and $total_score <= 1000){?>
				...
				<?php }// end foreach loop for $ghazatInfo?>
		...
		<?php }else{
			...
			<table  width="940" border="1" align="center" cellpadding="0" cellspacing="0">
			  ...
			  <?php }// end check for count ?>           	
			  	...
			  	<tr class="trsec">
				    ...
				    <td width="26" id="student-roll-now">
				    	<div align="center">
				    		<?php echo $info['std_roll_no'];?>
				    	</div>
				    </td>
				    <td width="60" id="student-name">
				    	<div align="center">
				    		<?php echo $info['std_name'];?>
				    	</div>
				    </td>
				    <td width="60" id="student-father-name">
				    	<div align="center">
				    		<?php echo $info['std_father_name'];?>
				    	</div>
				    </td>
				    <td width="70" id="student-dob-eng">
				    	<div align="center">
				    		<?php echo $info['std_dob_eng'];?>
				    	</div>
				    </td>
				    <td width="165" id="student-affliation-inst-shortname">
				    	<div align="center">
				    		<?php echo $info['affli_shortname'];?>
				    	</div>
				    </td>
					...
					<?php if($info['subject_id'] != ""){?>
				    	...
				    	<?php 
				    		...
				    		// echo '<pre>';print_r($r_subject_id);echo '</pre>';//die();
				    		...
				    		for($x = 0;$x < $iterator; $x++ ){?>
				    			...
				    			<?php /*if(isset($r_subject_id[$r_count]) and ($subject_id[$x] == $r_subject_id[$r_count]) and $r_obtained_marks[$r_count] != 0 ){*/
				    				if(isset($r_subject_id[$r_count]) and ($subject_id[$x] == $r_subject_id[$r_count]) ){
				    				 ?>
						    			...
						    			<td width="25" id="<?php if ($subject_id[$x] == $r_subject_id[$r_count]) { echo $r_subject_id[$r_count];}else{ echo $subject_id[$x];}?>">
						    				<div align='center'>
						    					<?php if($r_Sub_status[$r_count] == "absent"){?>
						    					...
						    					<?php }elseif($r_Sub_status[$r_count] == "cheat"){?>
						    					...
						    					<?php }elseif($r_obtained_marks[$r_count] < 40){?>
				    			...
				    			<?php }else{?>
						    			...
						    			<td width="25" id="sub-<?php echo $subject_id[$x];?>">
						    				<div align='center'>
							    				<?php if($sub_status[$x] == "absent"){?>
				    		...
				    		?>
							<td width="25" id="total-score">
								<div align='center'>
									<?php if($cheating){echo '0';}else{echo $new_total_score;}?>
								</div>
							</td>

			    			<?php if($rasibTrue){?>

				    			<td width="25" id="pass-or-fail"><div align='center'><?php echo "راسب"; ?></div></td>

				    		<?php }elseif($new_total_score >= 400){?>
			    		
			    				<td width="25" id="pass-or-fail"><div align='center'>ناجح</div></td>

			    			<?php }else{?>

			    				<td width="25" id="pass-or-fail"><div align='center'>راسب</div></td>
			    			
			    			<?php }?>

			    			<?php if($rasibTrue){?>

				    			<td width="25" id="marks-grade"><div align='center'><?php echo "راسب"; ?></div></td>

				    		<?php }elseif($new_total_score < 400){?>

				    			<td width="25" id="marks-grade"><div align='center'><?php echo "راسب"; ?></div></td>

				    		<?php }elseif($new_total_score >= 400 and $new_total_score <= 499){?>

				    			<td width="25" id="marks-grade"><div align='center'><?php echo "مقبول"; ?></div></td>

				    		<?php }elseif($new_total_score >= 500 and $new_total_score <= 599 ){?>

				    			<td width="25" id="marks-grade"><div align='center'><?php echo "جید"; ?></div></td>

				    		<?php }elseif($new_total_score >= 600 and $new_total_score <= 699){?>

				    			<td width="25" id="marks-grade"><div align='center'><?php echo "جید جدا"; ?></div></td>

				    		<?php }elseif($new_total_score >= 700 and $new_total_score <= 1000){?>

				    			<td width="25" id="marks-grade"><div align='center'><?php echo "ممتاز"; ?></div></td>
			...
			<?php } // end foreach loop $ghazetInfo

		 } // end else for exam type
	}else{
		echo "<p align=center>کوئ طالبعلم موجود نھیں ہے</a>";
	}?>
</body>
</html>