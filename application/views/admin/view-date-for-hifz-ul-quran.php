...
<?php $this->load->view('admin/navigation');?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">حفظ القران کی ڈیٹ شیٹ بنائیں</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="center">تاریخ امتحان حفظ القران </th>
                                        ...
                                        <?php foreach ($exam_center_array as $key => $einfo) { ++$key;?>
                                            <tr class="odd <?php if($key%2 == 0){?>even<?php }else{?>odd<?php }?>">
                                                ...
                                                <td class="center"><?php echo $einfo['hifzulquran_exam_date'];?></td>
                                                <td class="center">
                                                    ...
                                                    <a href="<?php echo base_url();?>admin/editDateSheetHifzQuran/<?php echo $einfo['eci_id'];?>"><button type="button" class="btn btn-warning btn-sm">ترمیم</button></a>
