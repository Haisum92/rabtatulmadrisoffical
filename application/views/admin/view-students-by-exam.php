...
<?php $this->load->view('admin/navigation');?>
			<!-- BEGIN PAGE CONTENT -->
             ...
             <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">طالب علم کا ریکارڈ دیکھنے کےلئے امتحان کا انتخاب کریں</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <?php }?>
    						    <?php
    							$attribute = array('class' => 'web_form','id' => 'view_students_by_exam',
                                                     'name' => 'view_students_by_exam', 'role' => 'form' );
        						echo form_open_multipart('admin/viewStudentsByExam',$attribute) ?>
                                    <div class="row">
