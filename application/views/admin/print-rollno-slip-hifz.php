...
<title>Print Hifz-ul-Quran Roll No Slips</title>
<style type="text/css">
body{
        ...
        <table width="100%" border="0" cellspacing="0">
          <tbody>
    	      ...
    	      <tr>
    	        ...
    	        <td class="border centerAlign" style="padding-top: 10px;padding-bottom: 10px;"><?php echo $esinfo['hifzulquran_exam_date'];?></td>
    	        <td class="border centerAlign" style="padding-top: 10px;padding-bottom: 10px;"><?php echo 'حفظ القرآن';?></td>      
    	      </tr>
          	  <tr id="margin-top">
