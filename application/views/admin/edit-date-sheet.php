...
<?php $this->load->view('admin/navigation');?>
			<!-- BEGIN PAGE CONTENT -->
             ...
             <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">ڈیٹ شیٹ کے لئے امتحان کا انتخاب کریں</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <?php }?>
                                <?php if($noDateSheetError and $noDateSheetError == true){?>
                                    <div class="alert alert-danger">
                                        <?php echo 'اس امتحان کی ڈیٹ شیٹ موجود نہیں ہے';?>
                                    </div>
                                <?php }?>
    						    <?php
    							$attribute = array('class' => 'web_form','id' => 'edit_datesheet',
                                                     'name' => 'edit_datesheet', 'role' => 'form' );
        						echo form_open_multipart('admin/editDateSheet',$attribute) ?>
                                    <div class="row">
