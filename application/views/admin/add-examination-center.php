...
<?php $this->load->view('admin/navigation');?>
			<!-- BEGIN PAGE CONTENT -->
             ...
             <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">نیا امتحانی مرکز</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
    							...
    							$attribute = array('class' => 'web_form','id' => 'add_examination_center', 'name' => 'add_examination_center',
                                                    'role' => 'form'
                                             );
        						echo form_open_multipart('admin/addExaminationCenter',$attribute) ?>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <label>Examination Center Name Urdu (امتحانی مرکز کا نام اردو میں)</label>
                                                <input type="text" name="exam_center_name_urdu" id="exam_center_name_urdu" class="form-control" placeholder="امتحانی مرکز کا نام اردو میں" value="<?php echo set_value('exam_center_name_urdu');?>" autocomplete="off" >
                                            ...
                                            <select class="form-control" name="exam_province" id="exam_province">
                                                    ...
                                                    <?php if($province_array != ""){
                                                        foreach ($province_array as $key => $province) {?>
                                                            <option value="<?php echo $province['prov_id'];?>"><?php echo $province['prov_name_urdu'];?></option>
                                                        <?php }
                                                    }?>
                                                </select>
                                                <!-- <p class="help-block">Example block-level help text here.</p> -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="exam_center_address" id="exam_center_address" rows="3"></textarea>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <!-- <div class="form-group">
                                                ...
                                                <input type="text" name="exam_center_name_eng" id="exam_center_name_eng" class="form-control" placeholder="امتحانی مرکز کا نام انگریزی میں" value="<?php echo set_value('prov_nane_eng');?>" autocomplete="off" >
                                            </div>-->
