                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <?php }?>
                                <?php if($alreadyDateSheetError and $alreadyDateSheetError == true){?>
                                    <div class="alert alert-danger">
                                        <?php echo 'اس امتحان کی ڈیٹ شیٹ پہلے ہی موجود ہے';?>
                                    </div>
                                <?php }?>
    						    <?php
    							$attribute = array('class' => 'web_form','id' => 'create_datesheet',
                                                     'name' => 'create_datesheet', 'role' => 'form' );
        						echo form_open_multipart('admin/createDateSheet',$attribute) ?>
                                    <div class="row">
