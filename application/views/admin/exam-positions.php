...
<?php $this->load->view('admin/navigation');?>
			<!-- BEGIN PAGE CONTENT -->
             ...
             <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">امتحانات میں پوزیشن</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
    							...
    							$attribute = array('class' => 'web_form','id' => 'position_for_exam', 'name' => 'position_for_exam', 'role' => 'form' );
        						echo form_open_multipart('admin/viewPositionsByExam/',$attribute) ?>
