        						...
        						echo form_open_multipart('admin/editExam/'.$exam_info[0]['exam_info_id'],$attribute) ?>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                <label>Exam Year in Hijri (ہجری)</label>
                                                <input type="text" name="exam_year_hijri" id="exam_year_hijri" class="form-control" placeholder="سال ہجری میں" value="<?php echo $exam_info[0]['exam_year_hijri'];?>" autocomplete="off" >
