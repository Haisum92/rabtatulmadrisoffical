...
<?php
	if ($gazetInfo != NULL) {
		...
		$count = 1;foreach ($gazetInfo as $key => $info) {?>
			...
			<h2>نتیجۃ امتحان <?php echo ''; ?> &nbsp;&nbsp;(کل نمبر: ۱۰۰)</h2>
			<table  width="940" border="1" align="center" cellpadding="0" cellspacing="0">
			  <tr class="trmain">
			    ...
			    <td width="145"><div align="center">المدرسۃ/دارلعلوم/الجامعۃ</div></td>
			    <td width="30"><div align="center">قرآن وحدیث</div></td>
			    <td width="30"><div align="center">النحو</div></td>
			    <td width="30"><div align="center">الفقہ</div></td>
			    <td width="30"><div align="center">اصول الفقہ</div></td>
			    <td width="30"><div align="center">المنطق</div></td>
			    <td width="30"><div align="center">اللغۃ العربیۃ</div></td>
			  ...
			  <tr class="trsec">
			    ...
			    <td width="145"><div align="center"><?php echo $info['affli_shortname'];?></div></td>
